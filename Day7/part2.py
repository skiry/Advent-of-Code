...
def max_thruster_signal_feedback(opcodes, available, last_result):
    global MAX
    if not available:
    ...
    for index, value in enumerate(available):
        ...
        max_thruster_signal_feedback(opcodes, new_available, c)

def max_thruster_signal(opcodes, available, last_result):
    if not available:
        max_thruster_signal_feedback(opcodes, [5, 6, 7, 8, 9], last_result)
